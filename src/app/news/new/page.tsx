...
import { handleAddNews } from '@/utils/newsUtilities';
...
export default function NewNews() {
    ...
    const handleSave = async () => {
        ...
        const response = await handleAddNews(title, subTitle, content, image, category, tags);
    ...
    return (
        <>
            <PageAccessCheck permission={['news-create']} />
            <div className="w-full px-2 md:px-24 py-5 flex flex-col items-center gap-5 text-text dark:text-darkText">
                <div className='w-full flex flex-col items-center gap-4 bg-card dark:bg-darkCard border border-border dark:border-darkBorder rounded-xl px-2 md:px-5 py-4 shadow-lg'>
                    ...
                    <div className='flex flex-col items-center gap-5'>
                        <Image src={`/${image}`} alt='News Thumbnail' width={800} height={400} className='rounded-lg border-2 border-border dark:border-darkBorder' />
