...
import { handleAddVideo } from '@/utils/videoUtilities';
...
export default function NewVideo() {
    ...
    const [contenId, setContenId] = useState('');
    ...
    const handleSave = async () => {
        const response = await handleAddVideo(title, description, contenId, category, tags);
    ...
    return (
        <>
            <PageAccessCheck permission={['video-create']} />
            <div className="w-full px-2 md:px-24 py-5 flex flex-col items-center gap-5 text-text dark:text-darkText">
                <div className='w-full flex flex-col items-center gap-4 bg-card dark:bg-darkCard border border-border dark:border-darkBorder rounded-xl px-2 md:px-5 py-4 shadow-lg'>
                    ...
                    <div className='flex flex-col items-center gap-3'>
                        {/* <Image
                                src={`https://img.youtube.com/vi/${image}/maxresdefault.jpg`}
                                alt='Video Thumbnail'
                                width={800} height={400}
                                className='aspect-video rounded-lg border-2 border-border dark:border-darkBorder'
                            /> */}
                        <iframe
                            className='rounded-lg border-2 border-border dark:border-darkBorder object-cover aspect-video lg:w-[800px] lg:h-[400px]'
                            src={`https://www.youtube.com/embed/${contenId}`}
